...
require('lazy').setup {
  ...
  -- stylua: ignore
  keys = {
    { "s", mode = { "n", "x", "o" }, function() require("flash").jump() end, desc = "Flash search forwards" },
    { "S", mode = { "n", "x", "o" }, function() require("flash").jump({
        search = { forward = false, wrap = false, multi_window = false },
      }) end, desc = "Flash search backwards" },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>st', builtin.treesitter, { desc = '[S]earch Treesitter ("." for repeat)' })
